    ...
    >
      ...
      <div className="z-10">
        ...
        <div className="socials flex flex-row gap-2">
          ...
          <Link href="https://linkedin.com/in/rdani2005" target="_blank">
      ...
      <div>
        <form className="flex flex-col">
          ...
          <button
            type="submit"
            className="transition bg-secondary-500 hover:bg-secondary-600 text-white font-medium py-2.5 px-5 rounded-lg w-full"
          >
            Send Message
          </button>
        </form>
